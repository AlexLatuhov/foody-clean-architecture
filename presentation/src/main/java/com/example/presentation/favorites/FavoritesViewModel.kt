...
class FavoritesViewModel @Inject constructor(
    ...
    fun insertFavoriteRecipe(favoritesEntity: FavoritesEntityDomain) =
        viewModelScope.launch(Dispatchers.IO) {
            ...
            favOperationResult.postValue(if (useCaseRes is OperationResult.Success) SuccessAdd else useCaseRes)
        }
    ...
    fun deleteFavoriteRecipe(vararg favoritesEntity: FavoritesEntityDomain) =
        viewModelScope.launch(Dispatchers.IO) {
            ...
            favOperationResult.postValue(if (useCaseRes is OperationResult.Success) SuccessRemove else useCaseRes)
        }
